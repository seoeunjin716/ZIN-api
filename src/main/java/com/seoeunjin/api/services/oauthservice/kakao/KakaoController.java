...
public class KakaoController {
                ...
                try {
                    ...
                    if (userId != null) {
                        ...
                        if (user != null) {
                            ...
                            redisTokenService.deleteAccessTokenByEmail("kakao", user.getEmail());
                        }
    ...
    public void kakaoCallback(
        ...
        try {
            ...
            e.printStackTrace();
            try {
                response.sendRedirect(frontendBaseUrl + "/login?error=kakao_auth_failed&message=" +
